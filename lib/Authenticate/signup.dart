...
import 'package:triveous_news_app/services/Authentication.dart';
              ...
              TextButton(
                  onPressed: () async {
                    if (_formkey.currentState!.validate()) {
                      ...
                      if(res==null){
                        const snackBar1=SnackBar(content: Text("Error in Signing up. Please check email is valid and password length is more than 6 characters " ,style: TextStyle(color: Colors.white),),backgroundColor: Colors.redAccent);
